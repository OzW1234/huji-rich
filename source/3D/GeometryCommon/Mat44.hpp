...
//! \brief A simple 4x4 Matrix
//! \remark The template argument is for the numeric data type of the matrix.
template <typename T>
class Mat44
{
private:
...
public:
...
#ifndef BOOST_NO_CXX11_HDR_INITIALIZER_LIST
	//! \brief Constructs a matrix with a C++11 initialization list
	...
	//! \brief Constructs a matrix and fills all its values.
	//! \remark C++03 compliant constructor.
	//! \remark This constructor runs faster than the initialization-list variant.
